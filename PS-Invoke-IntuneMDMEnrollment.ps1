...
function Set-PolicyKeys([ValidateSet('User','Device')]$Mode){
...
function Test-Mode([string]$Mode){
  $attempt=0
  $lastCode=$null
  do {
    $attempt++
...
# --- CA/MFA heuristic ---
function Get-Flag-CA($userCode,$devCode,[bool]$eventsPresent){
